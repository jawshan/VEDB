...
%         
    ...
    max_x_start=floor((i_col_max)*(sliding_width*Fs)); %4s second of sliding 4*Fs
    max_x_end=floor((i_col_max)*(sliding_width*Fs)+(window_size*Fs));% 6s window length 10*Fs
    
    shake_x_start=floor((i_col_shake)*(sliding_width*Fs)); %4s second of sliding 4*Fs
    shake_x_end=floor((i_col_shake)*(sliding_width*Fs)+(window_size*Fs));% 6s window length 10*Fs
